...
public class GtfsServicesReaderFactory {
   ...
   * @return created routed service reader
   */
  public static GtfsServicesReader create(final String inputDirectory, final String countryName, DayOfWeek dayOfWeek, MacroscopicNetwork parentNetwork, RouteTypeChoice typeChoice) {
    GtfsServicesReader serviceNetworkReader = create(new GtfsServicesReaderSettings(inputDirectory, countryName, dayOfWeek, parentNetwork, typeChoice));
    return serviceNetworkReader;
  }
